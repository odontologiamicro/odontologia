...
public class Publicador {
	...
	static final ApplicationContext cxt = new AnnotationConfigApplicationContext(RabbitConfig.class);
	static final AsyncRabbitTemplate asyncRabbitTemplate = cxt.getBean(AsyncRabbitTemplate.class);    
