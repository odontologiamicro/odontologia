...
public class RabbitConfig {
	...
	public static final String REQUEST_QUEUE_NAME = "miroservicios.odontologia.agenda.citaconsultada";
    public static final String REPLY_QUEUE_NAME = "miroservicios.odontologia.agenda.citaconsultadaReply";
    public static final String ROUTING_KEY_NAME = "miroservicios.odontologia.citaagendada.consultarcita";
